...
// ---------------------------------------------------------------------------------------------------
using DataItem = deadlock_detection::DataItem;
using DeadLockError = deadlock_detection::DeadLockError;
using Lock = deadlock_detection::Lock;
using LockManager = deadlock_detection::LockManager;
using LockMode = deadlock_detection::LockMode;
using Transaction = deadlock_detection::Transaction;
using WaitsForGraph = deadlock_detection::WaitsForGraph;
